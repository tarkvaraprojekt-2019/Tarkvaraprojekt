            ...
            <Layout title="Uus klient" error={this.state.error}>
                ...
                <Paper className={classes.paper}>
                    ...
                    <form className={classes.form} onSubmit={this.handleCreate}>
                      ...
                      {field('first_name', 'Eesnimi', letterPattern)} {/*bug in FF: https://bugzilla.mozilla.org/show_bug.cgi?id=1367105*/}
                      {field('last_name', 'Perenimi', letterPattern)} {/*bug in FF: https://bugzilla.mozilla.org/show_bug.cgi?id=1367105*/}
